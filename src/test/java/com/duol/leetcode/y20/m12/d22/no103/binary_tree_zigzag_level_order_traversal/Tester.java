...
public class Tester {
    ...
    private List<List<Integer>> expected;                    // parameter 4 (expected answer)
    ...
    public void test() {
        //
        List<List<Integer>> actual = solution.zigzagLevelOrder(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("zigzagLevelOrder() pass unit test!");
        }
    }
