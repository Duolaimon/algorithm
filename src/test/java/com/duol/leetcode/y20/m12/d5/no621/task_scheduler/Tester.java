/**
 * Leetcode - task_scheduler
 */
package com.duol.leetcode.y20.m12.d5.no621.task_scheduler;
...
public class Tester {
    ...
    public void test() {
        //
        int actual = solution.leastInterval(para1, para2);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("leastInterval() pass unit test!");
        }
    }
