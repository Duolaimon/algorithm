 ...
 */
package com.duol.leetcode.y20.m12.d8.no842.split_array_into_fibonacci_sequence;
...
public class Tester {
    ...
    public void test() {
        //
        List<Integer> actual = solution.splitIntoFibonacci(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("splitIntoFibonacci() pass unit test!");
        }
    }
