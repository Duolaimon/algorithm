 ...
 */
package com.duol.leetcode.y20.before.decode_string;
...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                ...
                {"3[a2[c]]", "accaccacc"},     // test case 2 (init parameters below: {para1, para2, expected})
                {"2[abc]3[cd]ef", "abcabccdcdcdef"}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
    ...
    public void test() {
        //
        String actual = solution.decodeString(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("decodeString() pass unit test!");
        }
    }
