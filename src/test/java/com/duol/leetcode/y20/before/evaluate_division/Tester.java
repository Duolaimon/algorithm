 ...
 */
package com.duol.leetcode.y20.before.evaluate_division;
...
public class Tester {
    ...
    private List<List<String>> para1;
    private double[] para2;
    private List<List<String>> para3;
    private double[] expected;                    // parameter 4 (expected answer)

    /** This constructor must be provided to run parameterized test. */
    public Tester(
            List<List<String>> para1,
            double[] para2,
            List<List<String>> para3,
            double[] expected
        ) {
    ...
    public void test() {
        //
        double[] actual = solution.calcEquation(para1, para2, para3);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("calcEquation() pass unit test!");
        }
    }
