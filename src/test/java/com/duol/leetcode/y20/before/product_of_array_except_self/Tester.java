 ...
 */
package com.duol.leetcode.y20.before.product_of_array_except_self;
...
public class Tester {
    ...
    public void test() {
        //
        int[] actual = solution.productExceptSelf(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("productExceptSelf() pass unit test!");
        }
    }
