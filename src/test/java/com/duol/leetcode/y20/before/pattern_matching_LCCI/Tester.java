/**
 * Leetcode - pattern_matching_LCCI
 */
package com.duol.leetcode.y20.before.pattern_matching_LCCI;
...
public class Tester {
    ...
    public void test() {
        //
        boolean actual = solution.patternMatching(para1, para2);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("patternMatching() pass unit test!");
        }
    }
