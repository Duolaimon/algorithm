 ...
 */
package com.duol.leetcode.y20.before.kids_with_the_greatest_number_of_candies;
...
public class Tester {
    ...
    public void test() {
        //
        List<Boolean> actual = solution.kidsWithCandies(para1, para2);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("kidsWithCandies() pass unit test!");
        }
    }
