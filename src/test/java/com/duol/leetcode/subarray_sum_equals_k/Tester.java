...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new int[]{1, 1, 1}, 2, 2},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
        //
        int actual = solution.subarraySum(para1, para2);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("subarraySum() pass unit test!");
        }
    }
