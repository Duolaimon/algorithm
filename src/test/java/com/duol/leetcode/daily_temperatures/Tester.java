...
//         solution = new Solution2();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new int[]{73, 74, 75, 71, 69, 72, 76, 73}, new int[]{1, 1, 4, 2, 1, 1, 0, 0}},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
        ...
        int[] actual = solution.dailyTemperatures(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("dailyTemperatures() pass unit test!");
        }
    }
