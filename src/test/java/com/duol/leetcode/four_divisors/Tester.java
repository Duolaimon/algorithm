...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
                {new int[]{21, 4, 7}, 32},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
        //
        int actual = solution.sumFourDivisors(para1);

        assertThat(actual, is(equalTo(expected)));

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("sumFourDivisors() pass unit test!");
        }
    }
