...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {ArrayUtil.newOneIntArray("[1,3,2,7]"), 4, 3},     // test case 1 (init parameters below: {para1, para2,
                // expected})
    ...
    public void test() {
        //
        int actual = solution.longestSubarray(para1, para2);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("longestSubarray() pass unit test!");
        }
    }
