...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {ArrayUtil.newOneIntArray("[1,1]"), ArrayUtil.newOneIntArray("[2,2]"),
                     ArrayUtil.newOneIntArray("[1,2]")},     // test
                // case 1 (init
                // parameters below: {para1,
                // para2,
                // expected})
    ...
    public void test() {
        //
        int[] actual = solution.fairCandySwap(para1, para2);
