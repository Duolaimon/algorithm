...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {ArrayUtil.newOneIntArray("[1,2,4,5,10]"), 16},     // test case 1 (init parameters below: {para1, para2,
                // expected})
    ...
    public void test() {
        //
        int actual = solution.tupleSameProduct(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("tupleSameProduct() pass unit test!");
        }
    }
