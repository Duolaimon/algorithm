 ...
 */
package com.duol.leetcode.y21.m1.d19.no1584.min_cost_to_connect_all_points;
...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {ArrayUtil.newTwoIntArray("[[2,-3], [-17,-8], [13,8], [-17,-15]]"), 53},     // test case 1 (init
    ...
    public void test() {
        //
        int actual = solution.minCostConnectPoints(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("minCostConnectPoints() pass unit test!");
        }
    }
