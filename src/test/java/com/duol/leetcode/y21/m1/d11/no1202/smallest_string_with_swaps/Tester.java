...
public class Tester {
    ...
    public void test() {
        //
        String actual = solution.smallestStringWithSwaps(para1, para2);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("smallestStringWithSwaps() pass unit test!");
        }
    }
