 ...
 */
package com.duol.leetcode.y21.m1.d18.no721.accounts_merge;
...
public class Tester {
    ...
    public void test() {
        //
        List<List<String>> actual = solution.accountsMerge(para1);
        
        assertThat(actual, is(equalTo(expected)));
        
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("accountsMerge() pass unit test!");
        }
    }
